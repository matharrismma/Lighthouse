...
scp "$r\api\codex.py" "$r\api\app.py" "$r\api\original_language.py" "$r\api\funnel.py" "$r\api\offices.py" "$r\api\cards.py" "$r\api\well_retriever.py" "$r\api\person_identity.py" "$r\api\synonymy.py" "$r\api\walk.py" "$r\api\embeddings.py" "$r\api\local_llm.py" "$r\api\floor.py" "$r\api\card_ssr.py" "$srv`:~/Lighthouse/api/"
Guard "scp api"
