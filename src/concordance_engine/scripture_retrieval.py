...
_REF_PATTERN = re.compile(
    ...
    r"(?:Gen|Exo?d?|Lev|Num|Deut?|Josh?|Judg?|Ruth|Sam?|Kgs?|Chr|Ezr?a?|"
    r"Neh|Est|Job|Ps(?:alm)?s?|Prov?|Eccl?|Song|Isa?|Jer|Lam|Ezek?|Dan|"
    r"Hos|Joel|Amos|Obad|Jon(?:ah)?|Mic|Nah|Hab|Zeph?|Hag|Zech?|Mal|"
    r"Matt?|Mar(?:k)?|Luk?e?|John?|Acts|Rom|Co(?:r|rint)?|Gal|Eph|Phil|"
    r"Col|Thess?|Tim|Tit|Phlm?|Heb|Jas|Pet|John?|Jude|Rev)"
    r"\s*\d+(?::\d+(?:-\d+)?)?\b",
    re.IGNORECASE,
)
