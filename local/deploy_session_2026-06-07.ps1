...
scp "$r\api\codex.py" "$r\api\app.py" "$r\api\original_language.py" "$r\api\funnel.py" "$r\api\offices.py" "$r\api\cards.py" "$r\api\well_retriever.py" "$r\api\person_identity.py" "$r\api\synonymy.py" "$r\api\walk.py" "$r\api\embeddings.py" "$r\api\local_llm.py" "$r\api\floor.py" "$r\api\card_ssr.py" "$r\api\packets_index.py" "$r\api\substrate.py" "$r\api\apothecary.py" "$r\api\witness_authorship.py" "$srv`:~/Lighthouse/api/"
Guard "scp api"
...
scp "$r\tools\grow_verified.py" "$r\tools\suggest_connections.py" "$r\tools\suggest_connections_verified.py" "$r\tools\steward_scheduler.py" "$r\tools\witness_registry.py" "$r\tools\source_witness_gate.py" "$srv`:~/Lighthouse/tools/"
