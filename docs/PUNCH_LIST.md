...
- [x] ~~**Make the map the navigation spine**~~ ✅ every front-door family entry now hubs its family: Codex (0a30b78), engine/gauntlet (0ca23ae), learn/read (0d2ae02), community/missions + write-keep/kept (ca4ac5b); apothecary/scribe/daily/media-center/assembly already hubs. (Atlas-as-living-connection-map remains a larger future build.)
