...
VERIFIERS: Dict[str, str] = {
    ...
    "rhetoric":             "concordance_engine.verifiers.rhetoric",
    "argumentation":        "concordance_engine.verifiers.rhetoric",
    "fallacy":              "concordance_engine.verifiers.rhetoric",
    "philosophy":           "concordance_engine.verifiers.philosophy",
    "ethics":               "concordance_engine.verifiers.philosophy",
    "epistemology":         "concordance_engine.verifiers.philosophy",
    "operations_research":  "concordance_engine.verifiers.operations_research",
    "or":                   "concordance_engine.verifiers.operations_research",
    "optimization":         "concordance_engine.verifiers.operations_research",
    "law":                  "concordance_engine.verifiers.law",
    "legal":                "concordance_engine.verifiers.law",
    "contract":             "concordance_engine.verifiers.law",
    "theology_doctrine":    "concordance_engine.verifiers.theology_doctrine",
    "theology":             "concordance_engine.verifiers.theology_doctrine",
    "doctrine":             "concordance_engine.verifiers.theology_doctrine",
    "scripture_doctrine":   "concordance_engine.verifiers.theology_doctrine",
    "history_chronology":   "concordance_engine.verifiers.history_chronology",
    "history":              "concordance_engine.verifiers.history_chronology",
    "chronology":           "concordance_engine.verifiers.history_chronology",
    "materials_science":    "concordance_engine.verifiers.materials_science",
    "materials":            "concordance_engine.verifiers.materials_science",
    "metallurgy":           "concordance_engine.verifiers.materials_science",
    "architecture":         "concordance_engine.verifiers.architecture",
    "building_design":      "concordance_engine.verifiers.architecture",
    "structural":           "concordance_engine.verifiers.architecture",
    "oceanography":         "concordance_engine.verifiers.oceanography",
    "ocean":                "concordance_engine.verifiers.oceanography",
    "marine_science":       "concordance_engine.verifiers.oceanography",
    "thermodynamics":       "concordance_engine.verifiers.thermodynamics",
    "thermo":               "concordance_engine.verifiers.thermodynamics",
    "heat":                 "concordance_engine.verifiers.thermodynamics",
    "nuclear_physics":      "concordance_engine.verifiers.nuclear_physics",
    "nuclear":              "concordance_engine.verifiers.nuclear_physics",
    "radioactivity":        "concordance_engine.verifiers.nuclear_physics",
    "ecology":              "concordance_engine.verifiers.ecology",
    "ecosystem":            "concordance_engine.verifiers.ecology",
    "environmental":        "concordance_engine.verifiers.ecology",
}
