...
|---|---|---|---|---|
| **USDA FoodData Central** | nutrition | PD | offline CSV (Foundation ~29MB / SR Legacy ~54MB) | The Table -- feed the hungry. Next in queue. |
...
language tree's phonics level; all 5 linguistic levels now grounded). Queue from here:
**IANA/RFC -> HYG -> CoolProp** (Tier 1,
