...
# Railway hosted API â set CONCORDANCE_API_URL env var to enable ledger routing.
...
def validate_packet(packet: Dict[str, Any], now_epoch: Optional[int] = None) -> Dict[str, Any]:
    ...
    Concordance is a Wisdom Engine — alignment to Source, not mere validation.
    Each gate asks a different calibration question:
      RED     — Does this violate any absolute boundary?
      FLOOR   — Does this meet every protective constraint?
      BROTHERS — Have the right witnesses confirmed this?
      GOD     — Has sufficient time passed for Source confirmation?
