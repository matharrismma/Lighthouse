"""MCP tool implementations (lw/ canonical tree).
...
def verify_biology(n_replicates=None, min_replicates=3, assay_classes=None,
    ...
    Standard checks (any combination):
      ...
      hardy_weinberg, primer, molarity, mendelian -- additional verifiers

    Health control systems (bio_control dict):
...
TOOLS: List[Dict[str, Any]] = [
    ...
    {"name": "verify_physics_conservation",
     "description": "Verify before/after match within tolerance. Optional 'law' (energy|momentum|charge|mass).",
     "inputSchema": {"type": "object",
    ...
    {"name": "verify_statistics_pvalue",
     "description": "Recompute p from inputs and compare to claimed_p.",
    ...
    {"name": "verify_statistics_confidence_interval",
     "description": "Verify CI well-formed and contains estimate.",
     "inputSchema": {"type": "object",
    ...
    {"name": "verify_governance_decision_packet",
     "description": "Decision packet structural check. Optional 'domain' activates per-domain profile.",
     "inputSchema": {"type": "object",
