...
_CLASSIFY_SYSTEM = (
    ...
    "  physics:                 {equation: \"...\", symbols: {SYM: \"unit_string\", ...}}  OR\n"
    "                            {before: {law: value}, after: {law: value}, law: \"energy|momentum|charge|mass\"}\n"
    ...
    "  thermodynamics:          {T_hot_K, T_cold_K, claimed_efficiency}  -- Carnot  OR\n"
    "                            {pressure_Pa, volume_m3, moles, temperature_K, claimed_pressure_Pa|claimed_volume_m3|...}  -- ideal gas  OR\n"
    "                            {mass_kg, specific_heat_J_per_kgK, delta_T_K, claimed_heat_J}  -- specific heat  OR\n"
    "                            {heat_J, temperature_K, claimed_entropy_change_J_per_K}  -- entropy\n"
    "  energy:                  {mass_kg, height_m, claimed_potential_energy_J}  OR\n"
    "                            {mass_kg, velocity_m_per_s, claimed_kinetic_energy_J}  OR\n"
    "                            {power_W, time_s, claimed_energy_J}\n"
    "  optics:                  {object_distance_m, focal_length_m, claimed_image_distance_m}  OR\n"
    "                            {wavelength_m, claimed_frequency_Hz}\n"
    "  electrical:              {voltage_V, current_A, claimed_resistance_ohm}  OR\n"
    "                            {voltage_V, current_A, claimed_power_W}  OR\n"
    "                            {resistors_ohm: [...], claimed_total_ohm, mode: \"series|parallel\"}\n"
    "  acoustics:               {frequency_Hz, wavelength_m, claimed_speed_m_per_s}  OR\n"
    "                            {power_W, reference_W, claimed_dB}  OR\n"
    "                            {source_frequency_Hz, source_velocity_m_per_s, observer_velocity_m_per_s, claimed_observed_frequency_Hz}\n"
    "  nuclear_physics:         {nuclide, claimed_half_life_s}  OR\n"
    "                            {mass_defect_kg, claimed_energy_J}\n"
    ...
    "  geometry:                {shape: \"circle|rectangle|triangle|sphere|...\","
                                " dimensions: {...}, claimed_area|claimed_perimeter|claimed_volume}\n"
    "  number_theory:           {n, claimed_is_prime}  OR  {a, b, claimed_gcd}  OR  {n, claimed_factors}\n"
    "  combinatorics:           {n, k, claimed_combinations|claimed_permutations}\n"
    "  formal_logic:            {premises: [...], conclusion: \"...\", claimed_valid: true|false}\n"
    "  statistics_pvalue:       {test: \"two_sample_t|paired_t|z|chi2|fisher_exact\","
                                " n1, n2, mean1, mean2, sd1, sd2, claimed_p, tail}\n"
    "  statistics_multiple_comparisons: {p_values: [...], alpha, method: \"bonferroni|holm|bh\", claimed_significant: [...]}\n"
    "  statistics_confidence_interval: {mean, sd, n, confidence_level, claimed_lower, claimed_upper}\n"
    "  information_theory:      {probabilities: [...], claimed_entropy_bits}\n"
    "  biology:                 {n_replicates, claimed_powered: true|false}  OR\n"
    "                            {dose: [...], response: [...], claimed_monotonic: true|false}  OR\n"
    "                            {p, q, claimed_AA, claimed_Aa, claimed_aa}  -- Hardy-Weinberg\n"
    "  genetics:                {parent1_genotype, parent2_genotype, claimed_ratio}  -- Mendelian\n"
    "  medicine:                {dose_mg, weight_kg, claimed_mg_per_kg}  OR  drug_name, indication, claimed_appropriate\n"
    "  nutrition:               {grams: {carbs, protein, fat}, claimed_kcal}\n"
    "  agriculture:             {zone_min_F, zone_max_F, claimed_zone}  OR  {ph, claimed_soil_class}\n"
    "  exercise_science:        {age, claimed_max_hr_bpm}  OR  {weight_kg, reps, claimed_one_rep_max_kg}\n"
    ...
    "  geology:                 {mineral_a, mineral_b, claimed_harder}  -- Mohs  OR\n"
    "                            {rock_type, claimed_classification}\n"
    "  meteorology:             {temp_F, dew_point_F, claimed_heat_index_F}  OR\n"
    "                            {temp_F, wind_mph, claimed_wind_chill_F}\n"
    "  hydrology:               {area_m2, rainfall_m_per_s, runoff_coefficient, claimed_discharge_m3_per_s}\n"
    "  astronomy:               {distance_pc, parallax_arcsec, claimed_match: true|false}  OR\n"
    "                            {apparent_magnitude, distance_pc, claimed_absolute_magnitude}\n"
    "  oceanography:            {temperature_C, salinity_psu, claimed_density_kg_per_m3}\n"
    "  geography:               {lat1, lon1, lat2, lon2, claimed_distance_km}\n"
    "  calendar_time:           {year, claimed_leap}  OR  {date, claimed_weekday}\n"
    "  computer_science:        {complexity_class, function_string, claimed_O}  OR\n"
    "                            {algo_name, input_size, claimed_runtime_ms}\n"
    "  cryptography:            {algo: \"sha256|md5|...\", message: \"...\", claimed_digest}\n"
    "  cybersecurity:           {password, claimed_entropy_bits}  OR  {cipher, key_length, claimed_secure}\n"
    "  networking:              {bandwidth_bps, payload_bytes, claimed_transit_seconds}  OR\n"
    "                            {ip, claimed_cidr_match}\n"
    "  quantum_computing:       {n_qubits, claimed_state_space}  OR  {gate, claimed_unitary: true|false}\n"
    "  music_theory:            {note_a, note_b, claimed_semitones}\n"
    "  photography:             {focal_length_mm, sensor_diagonal_mm, claimed_angle_of_view_deg}  OR\n"
    "                            {f_number, shutter_s, iso, claimed_ev}\n"
    "  sports_analytics:        {makes, attempts, claimed_pct}\n"
    "  linguistics:             {text, claimed_language}  OR  {word, claimed_etymology_root}\n"
    ...
    "  construction:            {length_m, width_m, depth_m, claimed_volume_m3}  -- concrete  OR\n"
    "                            {area_m2, coverage_m2_per_L, claimed_liters}  -- paint\n"
    "  architecture:            {floor_area_m2, lot_area_m2, claimed_FAR}  OR\n"
    "                            {area_m2, occupant_load_factor, claimed_occupants}\n"
    "  manufacturing:           {tact_time_s, units_per_shift, claimed_takt_time_s}\n"
    ...
    "  document_validation:     {document, schema, claimed_valid}\n"
    "  history_chronology:      {event, claimed_year}  OR  {event_a, event_b, claimed_event_a_before_event_b}\n"
    "  scripture_anchors:       {refs: [...], claimed_pattern}\n"
    "  theology_doctrine:       {claim, claimed_orthodox: true|false}\n"
    "  governance_decision_packet: {packet}\n"
    "  witness:                 {witnesses: [...], claimed_threshold_met}\n"
    "\n"
    "Conventions:\n"
