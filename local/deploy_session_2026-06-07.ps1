...
scp "$r\api\codex.py" "$r\api\app.py" "$r\api\original_language.py" "$r\api\funnel.py" "$r\api\offices.py" "$r\api\cards.py" "$r\api\well_retriever.py" "$r\api\person_identity.py" "$srv`:~/Lighthouse/api/"
Guard "scp api"
