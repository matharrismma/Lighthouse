...
| **DrugCentral (drug-target)** -- WIRED (`drug_target`, 2,587 drugs / 19,378 interactions, lw/00_source/drugcentral/drug_targets.db) | medicine | CC BY-SA | offline ~2.6MB SQLite | Apothecary MECHANISM layer: drug -> molecular target + action (INHIBITOR/AGONIST/...) + MOA. (Full pg dump 1.4GB has indications -- heavier, deferred.) |
