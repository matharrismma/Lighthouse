...
if __name__ == "__main__":
    ...
    test("Flat governance packet auto-wraps and PASSes",
         {
             "domain": "governance",
             "scope": "adapter",
             "created_epoch": PASS_TIME,
    ...
    test("packet wait_window_seconds=0 cannot lower adapter floor",
    ...
    test("packet wait_window_seconds=7200 raises adapter floor",
         base_packet(wait_window_seconds=7200),
         "QUARANTINE",
         now=PASS_TIME + 5000)

    # Same packet at +7300s is past the raised floor → PASS.
    test("packet wait_window_seconds=7200 satisfied past raised floor",
         base_packet(wait_window_seconds=7200),
         "PASS",
         now=PASS_TIME + 7300)
