...
scp "$r\site\index.html" "$r\site\nh-shell.js" "$r\site\marketplace.html" "$r\site\innovation.html" "$r\site\gaps.html" "$r\site\workspace.html" "$r\site\family.html" "$r\site\learn-deep.html" "$r\site\codex-deep.html" "$r\site\take-part.html" "$srv`:~/Lighthouse/site/"
Guard "scp site"
